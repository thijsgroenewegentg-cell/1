...
async function editSource({ path: rel, find, replace, content, replace_all }) {
  ...
  return {
    ...
    note: 'applied — restart_server if you edited server/lib code, and run npm test to verify',
  };
}
...
module.exports = { listSource, readSource, editSource, restartServer, git, PROJECT_ROOT };
