...
def _screen_find(description: str) -> tuple[int, int] | None:
    try:
        ...
        prompt = (
            ...
            f"described as: {description!r}. Reply ONLY with center coordinates x,y. "
            "If not visible, reply NOT_FOUND."
        )
        text = call_llm_text(prompt, images=[buf.getvalue()], num_predict=100, timeout=180)
        ...
        print(f"[ComputerControl] local screen_find failed: {e}")
    return None
