...
class Config:
    ...
    # Voice - PIPER FREE OFFLINE, but ElevenLabs CwhRBWXzGAHq8TQ4Fs17 for premium JARVIS voice if API key provided
    VOICE_ENABLED: bool = os.getenv("VOICE_ENABLED", "false").lower() == "true"
    WAKE_WORD: str = os.getenv("WAKE_WORD", "jarvis")
    TTS_ENGINE: str = os.getenv("TTS_ENGINE", "piper")  # piper = FREE offline British, elevenlabs = premium with CwhRBWXzGAHq8TQ4Fs17 voice
    TTS_VOICE: str = os.getenv("TTS_VOICE", "en_GB-alan-medium")  # Piper voice: British male
    ELEVENLABS_VOICE_ID: str = os.getenv("ELEVENLABS_VOICE_ID", "CwhRBWXzGAHq8TQ4Fs17")  # YOUR ElevenLabs voice - JARVIS premium
