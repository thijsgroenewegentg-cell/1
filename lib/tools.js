...
async function executeTool(name, args, ctx) {
  ...
  switch (name) {
    ...
    case 'play_music': {
      ...
      return { ok: true, query: q, service, links, note: 'PLAY buttons are shown to the user in the chat; clicking opens the music in a new tab. Mention which service you picked.' };
    }
    case 'maps': {
