...
PLUGIN = {
    ...
    "description": (
        "One or two sentences the local model uses to decide when to call this tool. "
...
def run(parameters: dict, player=None, session_memory=None) -> str:
    """
    parameters: dict of the args the local model extracted, matching PLUGIN['parameters'].
