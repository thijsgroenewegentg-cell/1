...
def _summarize_locally(transcript: str, video_url: str) -> str:
    """Summarise through Ollama; function name is retained for old callers."""
    from core.llm_client import call_llm_text
    truncated = transcript[:80000] + ("..." if len(transcript) > 80000 else "")
    return call_llm_text(
        "Summarize this YouTube transcript clearly and concisely. Structure it as "
        "a one-sentence overview followed by three to five key points. Output only the summary.\n\n"
        + truncated,
